...
#sed -i "s/en/zh_cn/g" ${defaultsettings}/files/zzz-default-settings
#sed -i "s/en/zh_cn/g" package/luci/modules/luci-base/root/etc/uci-defaults/luci-base
#sed -i "s/+@LUCI_LANG_en/+@LUCI_LANG_zh-cn/g" ${defaultsettings}/Makefile
